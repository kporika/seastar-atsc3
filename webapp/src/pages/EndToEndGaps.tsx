...
const GAPS: ReadonlyArray<GapRow> = [
    ...
    },
    {
        ...
        status: "in-flight",
        notes:
            "mmtp_desc + mmtp_desc_loop = Annex A.5 TLVs; protocol/mmtp_header_word0.yaml = ISO/IEC 23008-1 MMTP header first 32b; timestamp/PSN/packet_counter/extensions + MFU + PA/MPI/MPT + gw prefix still missing",
    },
    {
        layer: "Transport",
        spec: "RFC 5053 / 6330",
    ...
    },
    {
        ...
        status: "in-flight",
        notes:
            "lib/runtime/ipv4_udp.{hh,cc} encapsulate_ipv4_udp + checksums; ipv4udp-file:// sink; udp:// kernel path; protocol/lct_rfc5651_word0.yaml (LCT first word) + gw prepend (optional BE32 TSI / TOI(O=1), or both); protocol/mmtp_header_word0.yaml (MMTP header word 0, codegen only); full ROUTE/ALC/MMTP stack not in gw yet",
    },
    {
        layer: "Link",
        spec: "A/330 §5.2",
