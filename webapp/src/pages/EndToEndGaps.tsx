...
const ROADMAP: ReadonlyArray<{
    ...
    },
    {
        ...
        closes: [
            ...
            "MMTP packetizer (partial: mmtp_header_* + mmtp_desc + gw prepend lab + mmt_probe strip/expect for word-0, ts_psn, packet_counter, chained X extensions, signalling §9.3.4 prefix + aggregation peel, ISOBMFF 64b prefix peel + optional DU_header strip (A=0) + A=1 DU_length peel; integration E–Q)",
                ...
                <Grid columns={2} gap={12}>
                    ...
                    <BulletGroup
                        ...
                        items={[
                            ...
                            "scripts/run_all_integration.sh — sink/LLS/STLTP + admin + M7 + LCT word‑0 + MMTP lab (E–Q) + RTCM 12×96",
                            ...
                            "scripts/mmtp_word0_integration_test.sh — E/word‑0 only · F/word‑0+LCT · G/word‑0+ts_psn · H/word‑0+extension · I/word‑0+ts_psn+extension · J/word‑0+ts_psn+packet_counter · K/full prefix stack · L/word‑0+signalling prefix · M/word‑0+chained X · N/word‑0+signalling aggregation · O/word‑0+ISOBMFF prefix (A=0) · P/word‑0+ISOBMFF aggregation (A=1) · Q/word‑0+ISOBMFF DU_header (T=0); mmt_probe verify --strip-mmtp-word0 / --strip-mmtp-ts-psn / --strip-mmtp-packet-counter / --strip-mmtp-extension / --strip-mmtp-signalling-prefix / --strip-mmtp-signalling-aggregate-count / --strip-mmtp-isobmff-prefix / --strip-mmtp-isobmff-du-header [--expect-mmtp-*] [--expect-mmtp-isobmff-du-*] [--expect-mmtp-isobmff-aggregate-hex] + optional --strip-lct-word0",
