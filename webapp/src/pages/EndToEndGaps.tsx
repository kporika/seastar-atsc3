...
const STACK: ReadonlyArray<{
    ...
    {
        layer: "Transport",
        blurb: "ROUTE/LCT for DASH, MMTP for MMT (§10.3 validate lab through AAT), Raptor10/RaptorQ FEC — LCT word-0 + mmt_si_* lab landed",
        status: "in-flight",
    },
    {
...
const ROADMAP: ReadonlyArray<{
    ...
    },
    {
        ...
        blurb:
            ...
            "Full ROUTE/LCT sessions, Raptor10/RaptorQ FEC, production gw MMTP emit beyond the prepend/validate lab, and a receiver-style depacketizer remain. The gw/mmt_probe harness already covers scripts/mmtp_word0_integration_test.sh phases E–AAT (ISOBMFF A=0|1, DU_length, optional DU_header strip/expect, GFD peel, ALP pc/hm, signalling §9.3.4 V–X, §10.2/§10.3 Y–AAT including full MPT asset id 0/1/2 × location + descriptors4 and full PLT delivery/package matrix). " +
        ...
        closes: [
            ...
            "MMTP packetizer (partial: mmtp_header_* + mmtp_desc + mmt_si_* §10.3 validate lab (MPT/PLT tables, assets, packages, delivery) through AAT + gw prepend + mmt_probe strip/expect for word-0, ts_psn, counter, extensions, signalling §9.3.4, ISOBMFF/GFD peels; integration E–AAT; production depacketizer still open)",
                ...
                <Grid columns={2} gap={12}>
                    ...
                    <BulletGroup
                        ...
                        items={[
                            ...
                            "protocol/mmt_si_* — §10.2/§10.3 validate lab (length32 envelope, descriptor loop, message header, PA tables, MPT/PLT tables + body prefixes, full MPT asset id 0/1/2 × location + descriptors4, full PLT delivery + package matrix); integration phases ZK–AAT",
                    ...
                    <BulletGroup
                        ...
                        items={[
                            ...
                            "scripts/run_all_integration.sh — fixed order: integration + udp + ipv4udp + stltp + lls + admin + M7 + lct_word0 (A–D) + mmtp_word0 (E–AAT) + rtcm 12×96 (= make integ-all)",
                            ...
                            "scripts/mmtp_word0_integration_test.sh — E–U prefix/ISOBMFF/GFD/ALP · V–X signalling §9.3.4 packet_id · Y–ZF §10.2/§10.3 envelopes + PA tables · ZG/ZH MPT/PLT tables · ZI/ZJ body prefixes",
                            "scripts/mmtp_word0_integration_test.sh — ZK–AAT §10.3 matrix: MPT asset (ZK, ZS, ZT, ZV, ZW, ZY, AAA, AAC, AAF, AAG, AAH, AAM, AAN, AAO–AAT) + PLT delivery/package (ZL–ZZ, AAB, AAD, AAE, AAI–AAL); mmt_probe strip/expect (--strip-mmtp-*, --strip-mmt-si-*, --expect-mmtp-*, --expect-mmt-si-*, --expect-alp-*) + optional --strip-lct-word0; see docs/END_TO_END_GAPS.md for per-phase YAML names",
