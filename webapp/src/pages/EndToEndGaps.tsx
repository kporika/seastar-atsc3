    ...
    return (
        <Stack gap={28}>
            ...
            <Stack gap={12}>
                ...
                <Text tone="secondary">
                    Today the project owns one slice of the broadcast stack — the
                    ALP + TLV-mux link layer plus a Seastar TCP gateway. To answer{" "}
                    <Text as="span" weight="semibold">
                        "put this content into ATSC 3.0 and pass it to the
                        exciter"
                    </Text>{" "}
                    you need a layer above (input API + content packaging +
                    service signaling) and a layer below (the A/324
                    broadcast-gateway → exciter handoff). Below is the inventory
                    of every protocol-level component, grouped by layer, with the
