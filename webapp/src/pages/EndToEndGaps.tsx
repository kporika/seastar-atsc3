    ...
    return (
        <Stack gap={28}>
            ...
            <Grid columns={4} gap={16}>
                <Stat
                    value={doneGaps}
                    label="Done in atsc3_proto"
                    tone="success"
                />
                <Stat
                    value={inScopeMissing}
                    label="Missing (in scope)"
                    tone="warning"
                />
                <Stat
                    value={externalGaps}
                        ...
                        <CardBody>
                            <Stack gap={8}>
                                <Text>
                                    ...
                                    HTTP endpoint inside the existing Seastar
                                    gateway (use seastar/http) that accepts a
                                    JSON envelope:
                                </Text>
                                <Text size="small">
                                ...
                                <Text>
                                    The gateway routes by `type` into the
                                    existing encoder pipeline, plus a new{" "}
                                    <Text as="span" weight="semibold">
                                        lls://
                                    </Text>{" "}
                                    sink that emits LLS-framed XML on a
                                    configurable multicast IP. Two days of work.
                                </Text>
                            </Stack>
                        </CardBody>
                    </Card>
                        ...
                        <CardBody>
                            <Stack gap={8}>
                                <Text>
                                    ...
                                    that wraps each TLV-mux frame in a minimal
                                    A/324 STLTP packet (BBP for one PLP,
                                    hard-coded L1B/L1D, monotonic-counter
                                    timestamps, no PTP).
                                </Text>
                                <Text>
